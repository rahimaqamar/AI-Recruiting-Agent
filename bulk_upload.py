...
def bulk_upload():
    ...
    for filename in pdf_files:
        ...
        try:
            ...
            category = extract_category(resume_text)  # abhi bhi compute ho raha hai, DB mein save nahi hota
            ...
            add_resume(
                ...
                education=education,
                location=location
                # category hata diya — rag.py ka add_resume() ise accept nahi karta
            )
